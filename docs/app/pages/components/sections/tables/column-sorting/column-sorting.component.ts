...
export class ComponentsColumnSortingComponent {
    ...
    // THIS IS ALL TEST STUFF BELOW THIS POINT

    testNum: number;

    // onChange (columnSortingState: ColumnSortingState) {
    //     if (columnSortingState === ColumnSortingState.Ascending) {
    //         console.log('ascending');
    //     }
    // }

    test(valueColumn: ColumnSortingComponent) {
        if (this.testNum !== 1) {
            valueColumn.updateState();
            this.testNum = 1;
        } else {
            valueColumn.updateState();
            this.testNum = null;
